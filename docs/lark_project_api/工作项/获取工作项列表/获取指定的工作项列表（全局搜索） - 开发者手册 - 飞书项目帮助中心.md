---
title: "获取指定的工作项列表（全局搜索） - 开发者手册 - 飞书项目帮助中心"
source: "https://project.feishu.cn/b/helpcenter/1p8d7djs/42w754bv"
author:
published:
created: 2026-03-21
updated: 2026-03-21
description: "按标题、描述、人员等多字段跨空间搜索工作项实例"
tags:
  - "飞书项目"
  - "工作项"
  - "获取工作项列表"
...
| simple_names    | list<string> | 可选   | 安装插件的飞书项目空间（simple_name）列表。simple_name 一般在飞书项目空间 URL 中获取。例如空间 URL为 "https://project.feishu.cn/doc/overview"，则 simple_name为 "doc"。 |
...
| 参数 | 类型 | 说明 |
| --- | --- | --- |
| data | list<object> | 最多只能查询到匹配度最高的前200条数据，遵循 [CompInfo](https://project.feishu.cn/b/helpcenter/1p8d7djs/1x1d372l#43836e24) 结构规范 |
