---
title: "获取指定的工作项列表（跨空间） - 开发者手册 - 飞书项目帮助中心"
source: "https://project.feishu.cn/b/helpcenter/1p8d7djs/1hpwuxld"
author:
published:
created: 2026-03-21
updated: 2026-03-21
description: "跨多个空间搜索符合条件的工作项实例"
tags:
  - "飞书项目"
  - "工作项"
  - "获取工作项列表"
...
| 参数                    | 类型           | 是否必须 | 说明                                                                                                                                                                                                                                                                                                                                                                                    |
| --------------------- | ------------ | ---- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| project_keys         | list<string> | 可选   | 空间 ID 列表，project_key 在飞书项目空间双击空间名称获取。  - 若填了project_keys，则查询安装了插件的空间工作项信息。 - 未传project_keys，则查询 header 中用户有权限的空间中安装了插件的空间工作项信息。                                                                                                                                                                                                                                                    |
...
| work_item_type_key | string       | 必须   | 工作项类型，可通过 [获取空间下工作项类型](https://project.feishu.cn/b/helpcenter/1p8d7djs/3pjp854w) 获取                                                                                                                                                                                                                                                                                                   |
| work_item_name      | string       | 可选   | 工作项名称(支持模糊搜索)。                                                                                                                                                                                                                                                                                                                                                                        |
| search_user          | object       | 可选   | 用户信息列表（支持搜索指定人员为该用户的相关工作项），遵循 [SearchUser](https://project.feishu.cn/b/helpcenter/1p8d7djs/1x1d372l#b4eb8859) 结构规范                                                                                                                                                                                                                                                                    |
| work_item_ids       | list<int64>  | 可选   | 工作项 ID，在工作项实例详情右上角展开 **···** ，单击 ID 信息即可获取。                                                                                                                                                                                                                                                                                                                                           |
| created_at           | object       | 可选   | 创建时间（支持时间区间查询，可不传截止时间，代表至今）。                                                                                                                                                                                                                                                                                                                                                          |
| updated_at           | object       | 可选   | 更新时间（支持时间区间查询，可不传截止时间，代表至今）。                                                                                                                                                                                                                                                                                                                                                          |
| work_item_status    | list<object> | 可选   | 工作项状态列表，筛选当前处于列表内状态的工作项实例，遵循 [WorkItemStatus](https://project.feishu.cn/b/helpcenter/1p8d7djs/1x1d372l#9b44f95f) 结构规范。可从以下途径获取：  - [获取字段信息](https://project.feishu.cn/b/helpcenter/1p8d7djs/3tsposa2) 接口中 work_item_status 的 options 中获取，选择对应的 value。 - [获取创建工作项元数据](https://project.feishu.cn/b/helpcenter/1p8d7djs/2jhqmwhn) 接口中的 work_item_status 字段的 options 中获取，选择对应的 value。 |
...
| template_ids         | list<int64>  | 可选   | 模板 ID 列表，用于筛选使用指定模板创建的工作项。可通过以下途径获取模板 ID：  - [获取创建工作项元数据](https://project.feishu.cn/b/helpcenter/1p8d7djs/2jhqmwhn) 接口中的 template 字段的 options 中获取； - [获取工作项下的流程模板列表](https://project.feishu.cn/b/helpcenter/1p8d7djs/3pq8jlhd) 接口的 template_id； - [获取字段信息](https://project.feishu.cn/b/helpcenter/1p8d7djs/3tsposa2) 接口中的 template 字段的 options中获取。                                   |
...
| 参数 | 类型 | 说明 |
| --- | --- | --- |
| data | list<object> | 遵循 [WorkItemInfo](https://project.feishu.cn/b/helpcenter/1p8d7djs/1x1d372l#a16fbe28) 结构规范 |
...
| 20003 | Wrong WorkItemType Param | 20003 | work_item_type_key should not empty | - 获取指定的工作项列表：work_item_type_keys 未填 - 目标工作项为状态流，但是设置了 expand 参数:{ "need_workflow":true} |
