---
title: "获取工作项详情 - 开发者手册 - 飞书项目帮助中心"
source: "https://project.feishu.cn/b/helpcenter/1p8d7djs/r9jxqxnd"
author:
published:
created: 2026-03-21
updated: 2026-03-21
description: "获取指定空间和工作项类型下的工作项实例详细信息，包括所有字段信息"
tags:
  - "飞书项目"
  - "工作项"
  - "工作项实例读写"
...
category: "飞书项目"
related_docs:
  - "[[创建工作项 - 开发者手册 - 飞书项目帮助中心]]"
  - "[[更新工作项 - 开发者手册 - 飞书项目帮助中心]]"
  - "[[删除工作项 - 开发者手册 - 飞书项目帮助中心]]"
---
...
- 请求地址：/open\_api/:project\_key/work\_item/:work\_item\_type\_key/query
...
| work_item_type_key | string | 必须   | 工作项类型，创建工作项时自动生成，通过 [获取空间下工作项类型](https://project.feishu.cn/b/helpcenter/1p8d7djs/3pjp854w) 接口获取。                                                                                                           |
...
| fields | list<string> | 可选 | 工作项中的字段标识，非必填，默认返回全部。字段格式可查看 [字段与属性解析格式](https://project.feishu.cn/b/helpcenter/1p8d7djs/1tj6ggll) 。支持两种模式，两种模式不可混用。  - 指定字段：仅返回fields 中列出的字段。例如 ["aborted","role_owners"] 表示只返回 aborted 和 role_owners 字段。 - 排除字段：以 - 开头表示排除该字段。例如 ["-aborted","-role_owners"] 表示返回除aborted和 role_owners 外的所有字段。 |
...
| 参数 | 类型 | 说明 |
| --- | --- | --- |
| data | list<object> | 该返回结构遵循结构体 [WorkItemInfo](https://project.feishu.cn/b/helpcenter/1p8d7djs/1x1d372l#a16fbe28) 格式与规范。 |
...
请求路径：POST/open\_api/68382b399de4b0ec6c5axxxx/work\_item/story/query
...
| 30014 | WorkItem Type Not Found | 30014 | WorkItem Type Not Found | work_item_type_key错误，请通过 [获取空间下工作项类型](https://project.feishu.cn/b/helpcenter/1p8d7djs/3pjp854w) 接口获取。 |