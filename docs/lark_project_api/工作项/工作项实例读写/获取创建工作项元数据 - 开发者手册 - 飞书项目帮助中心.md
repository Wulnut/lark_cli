---
title: "获取创建工作项元数据 - 开发者手册 - 飞书项目帮助中心"
source: "https://project.feishu.cn/b/helpcenter/1p8d7djs/2jhqmwhn"
author:
published:
created: 2026-03-21
updated: 2026-03-21
description: "获取指定工作项类型的元数据，包括所有字段信息，用于创建和更新工作项"
tags:
  - "飞书项目"
  - "工作项"
  - "工作项实例读写"
...
| 参数 | 类型 | 说明 |
| --- | --- | --- |
| data | list<object> | 返回值，遵循 [FieldConf](https://project.feishu.cn/b/helpcenter/1p8d7djs/1x1d372l#92c2e781) 结构规范 |
  ...
  "data": [//注：若想在接口中返回字段，需在该工作项的详情页配置中添加该字段
    {
      ...
      "is_visibility": 1, // 可见性，1：可见；2：条件可见
      "label": "name", // 表单项名称
